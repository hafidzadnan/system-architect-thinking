    ...
    <div className="page-content">
      ...
      {filtered.length === 0 ? (
        <div className="empty-state">
          ...
          <p>
            Buat sesi baru untuk memulai proses pengambilan keputusan
            terstruktur.
          </p>
          <button
            ...
            >
              ...
              >
                <span style={{ fontSize: 13, color: '#64748B' }}>
                  📅 Target: {session.targetDate}
                </span>
                <span style={{ fontSize: 13, color: '#64748B' }}>
                  Fase {session.currentPhase} dari 5
                </span>
              </div>
        ...
        <div className="modal-overlay" onClick={() => setShowModal(false)}>
          <div className="modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="form-group">
              ...
              <input
                className="input"
                placeholder="Contoh: Migrasi Supervisi KPPN ke Platform Digital"
                maxLength={100}
              />
            ...
            <div className="form-group">
              ...
              <textarea
                className="textarea"
                placeholder="Deskripsi singkat tentang keputusan yang akan dianalisis..."
              />
            </div>
            <div className="form-group">
            ...
            <div className="form-group">
              ...
              >
                <input type="checkbox" /> Gunakan template studi kasus (Migrasi
                Supervisi KPPN)
              </label>
            </div>
