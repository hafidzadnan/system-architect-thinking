        ...
        <div className="import-panel">
          <div>
            <div className="form-group">
              <label>
                Prompt Template (Salin dan jalankan pada LLM eksternal)
              </label>
            ...
            <button className="btn btn-ai">
              🔄 Parse & Tampilkan Rekomendasi
            </button>
          </div>
          <div className="import-recommendations">
            <h4>📥 Rekomendasi dari AI Agent</h4>
            <p style={{ fontSize: 13, color: '#3730A3', marginBottom: 12 }}>
              Paste JSON di panel kiri, lalu klik &quot;Parse&quot; untuk
              menampilkan rekomendasi di sini.
            </p>
            <div className="import-rec-item">
              <p>
                <strong>Root Objective:</strong> Meningkatkan efisiensi
                supervisi KPPN melalui migrasi ke platform digital terintegrasi
              </p>
              <button className="btn btn-sm btn-ai">Gunakan</button>
            </div>
            <div className="import-rec-item">
              <p>
                <strong>Function Tag:</strong> Motivational Function
              </p>
              <button className="btn btn-sm btn-ai">Gunakan</button>
            </div>
            <div className="import-rec-item">
              <p>
                <strong>Function Justification:</strong> Digitalisasi merupakan
                langkah inovatif untuk meningkatkan kapasitas pengawasan tanpa
            ...
            <div className="import-rec-item">
              <p>
                <strong>Internal Parameter:</strong> Kapasitas SDM KPPN
                bervariasi dalam mengadopsi teknologi baru
              </p>
              <button className="btn btn-sm btn-ai">Gunakan</button>
            </div>
            <div className="import-rec-item">
              <p>
                <strong>External Constraint:</strong> Luasnya demografi wilayah
                dan kondisi jaringan internet bervariasi
              </p>
              <button className="btn btn-sm btn-ai">Gunakan</button>
            </div>
            ...
            <div className="import-rec-item">
              <p>
                <strong>Task:</strong> Sosialisasi platform digital ke seluruh
                KPPN
              </p>
              <button className="btn btn-sm btn-ai">Gunakan</button>
            </div>
            <div className="import-rec-item">
              <p>
                <strong>Task:</strong> Penyusunan modul pelatihan teknis
              </p>
              <button className="btn btn-sm btn-ai">Gunakan</button>
            </div>
          </div>
        ...
        <>
          ...
          <div className="phase-section">
            ...
            <div style={{ display: 'flex', gap: 16 }}>
              ...
              >
                <input type="radio" name="functionTag" />{' '}
                <div>
          ...
          <div className="phase-section">
            <h3>
              ...
              <span className="tooltip-wrap">
                <span className="tooltip-icon">?</span>
                <span className="tooltip-content">
                  Pemetaan variabel lingkungan menggunakan analisis kondisi
                  (SWOT). Variabel dipecah menjadi Internal Parameters, External
            ...
            <div className="dynamic-list">
              {items.params.map((_, i) => (
                <div key={i} className="dynamic-list-item">
                  <input
                    className="input"
                    placeholder="Contoh: Kapasitas SDM KPPN bervariasi dalam mengadopsi teknologi baru"
                  />
                  <button
            ...
            <div className="dynamic-list">
              {items.constraints.map((_, i) => (
                <div key={i} className="dynamic-list-item">
                  <input
                    className="input"
                    placeholder="Contoh: Luasnya demografi wilayah dan kondisi jaringan internet bervariasi"
                  />
                  <button
                    className="btn-remove"
                    onClick={() =>
                      setItems((prev) => ({
                        ...prev,
                        constraints: prev.constraints.filter((_, j) => j !== i),
                      }))
                    }
                  >
                    ✕
