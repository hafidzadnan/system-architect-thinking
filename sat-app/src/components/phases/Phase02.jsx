...
export default function Phase02({ onNext, onPrev }) {
  const [unplottedTasks, setUnplottedTasks] = useState([
    {
      id: 1,
      name: 'Sosialisasi platform digital ke seluruh KPPN',
      u: '',
      i: '',
    },
  ...
  const updateUnplotted = (id, field, value) => {
    setUnplottedTasks(
      unplottedTasks.map((t) => (t.id === id ? { ...t, [field]: value } : t)),
    )
  }
  ...
  return (
    <div>
      <div className="phase-header">
        ...
        <p>
          Definisi Variabel & Batasan: Konversi data lingkungan menjadi variabel
          teknis yang terukur
        </p>
      </div>
      ...
      <div className="phase-section">
        ...
        <div style={{ marginBottom: 24 }}>
          <p style={{ fontSize: 14, marginBottom: 12, color: '#475569' }}>
            Daftar tugas (tasks) di bawah ini diambil dari rekomendasi AI di
        ...
        >
          ...
          <div className="eq-cell eq-q1">
            ...
            <div className="eq-subtitle">
              Penting & Mendesak → Eksekusi Langsung
            </div>
            {getQuadrant(1).map((t) => (
              <div
                key={t.id}
              ...
              >
                ...
                <div style={{ display: 'flex', gap: 4 }}>
                  ...
                  <button
                    ...
                    onClick={() => handleRemovePlotted(t.id)}
                    title="Hapus"
                  >
                    ✕
                  </button>
