  ...
  return (
    <div>
      ...
      <div className="alert alert-success" style={{ marginBottom: 24 }}>
        ...
        <span>
          Sesi keputusan telah diselesaikan. Seluruh data telah dikunci dan
          bersifat read-only.
        </span>
      </div>
      ...
      <div className="summary-section">
        ...
        <div className="summary-item">
          ...
          <span className="summary-value">
            Meningkatkan efisiensi dan akuntabilitas supervisi KPPN melalui
            migrasi ke platform digital terintegrasi
          </span>
        </div>
        <div className="summary-item">
          <span className="summary-label">Function Tag</span>
          <span className="summary-value">
            <span className="badge badge-draft">Motivational Function</span>
          </span>
        </div>
      </div>
      ...
      <div className="summary-section">
        ...
        <div className="summary-item">
          <span className="summary-label">Total Variabel</span>
          <span className="summary-value">4 Variabel</span>
        </div>
        <div className="summary-item">
          <span className="summary-label">Status Sanitasi</span>
          <span className="summary-value">
            <span className="badge badge-done">Semua Lolos / Diterima</span>
          </span>
        </div>
      </div>
      ...
      <div className="summary-section">
        ...
        <div className="summary-item">
          <span className="summary-label">Opsi A (Status Quo)</span>
          <span className="summary-value">EV = 7.7</span>
        </div>
        <div className="summary-item">
          <span className="summary-label">Opsi B (Migrasi Digital)</span>
          <span
      ...
      <div className="summary-section">
        ...
        <div className="summary-item">
          ...
          <span className="summary-value">
            <span className="badge badge-done">Aman (EV Ke Depan Positif)</span>
          </span>
        </div>
        <div className="summary-item">
          <span className="summary-label">Cobra Effect Monitoring</span>
          <span className="summary-value">Pemantauan Bulanan (3 Metrik)</span>
        </div>
        <div className="summary-item">
          <span className="summary-label">Stakeholder Matrix</span>
          <span className="summary-value">
            <span className="badge badge-benefit">Intelligent (Win-Win)</span>
          </span>
        </div>
      </div>
