  ...
  return (
    <div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
          <div className="card" style={{ padding: 12 }}>
            <div style={{ display: 'flex', gap: 12, alignItems: 'center' }}>
              ...
              <input
                className="input"
                defaultValue="Supervisi Konvensional (Kunjungan Fisik / Status Quo)"
                style={{ flex: 1 }}
              />
            </div>
          </div>
          <div className="card" style={{ padding: 12 }}>
            <div style={{ display: 'flex', gap: 12, alignItems: 'center' }}>
              ...
              <input
                className="input"
                defaultValue="Migrasi ke Platform Digital Terintegrasi"
                style={{ flex: 1 }}
              />
            </div>
          </div>
      ...
      <div className="phase-section">
        <h3>
          B. Mapping Kriteria
          <button className="btn btn-sm btn-ai" style={{ marginLeft: 12 }}>
          ...
          <table className="ev-table">
            <thead>
              <tr>
                ...
                <th>Tipe</th>
                <th>Bobot</th>
                <th colSpan="3" style={{ background: '#475569' }}>
                  Opsi A: Konvensional
                </th>
                <th colSpan="3" style={{ background: '#1B2A4A' }}>
                  Opsi B: Digital
                </th>
              </tr>
              <tr>
                ...
                <th></th>
                <th></th>
                <th style={{ background: '#64748B', fontSize: 11 }}>Nilai</th>
                <th style={{ background: '#64748B', fontSize: 11 }}>Prob.</th>
                <th style={{ background: '#64748B', fontSize: 11 }}>EV</th>
                <th style={{ background: '#2D4A7A', fontSize: 11 }}>Nilai</th>
                <th style={{ background: '#2D4A7A', fontSize: 11 }}>Prob.</th>
                <th style={{ background: '#2D4A7A', fontSize: 11 }}>EV</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                ...
                <td>
                  <input className="input" defaultValue="0.7" />
                </td>
                <td>
                  <strong>42.0</strong>
                </td>
              ...
              <tr>
                ...
                <td>0.40</td>
                <td>
                  <input className="input" defaultValue="40" />
                </td>
                <td>
                  <input className="input" defaultValue="0.8" />
                </td>
              ...
              <tr>
                ...
                <td>
                  <input className="input" defaultValue="0.5" />
                </td>
              ...
              <tr style={{ background: '#F8FAFC', fontWeight: 700 }}>
                ...
                <td colSpan="3" style={{ fontSize: 18 }}>
                  7.7
                </td>
                <td
                  colSpan="3"
      ...
      <div className="phase-section">
        ...
        >
          ...
          <div>
            <strong>
              Rekomendasi: Opsi B — Migrasi ke Platform Digital Terintegrasi
            </strong>
            <p style={{ fontSize: 13, marginTop: 4 }}>
              EV = 57.6, jauh melampaui Opsi A (7.7). Opsi ini mendemonstrasikan
              kelayakan sistemik yang lebih tinggi.
            </p>
          </div>
        </div>
      </div>
